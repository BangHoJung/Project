...
public class QnaDTO {
	...
	public QnaDTO(int qna_no, String qna_member_no, String qna_title, String qna_content, String qna_date,
	...
	public String getQna_member_no() {
		return qna_member_no;
	}

	public void setQna_member_no(String qna_member_no) {
		this.qna_member_no = qna_member_no;
	}
	...
	public String toString() {
		return "QnaDTO [qna_no=" + qna_no + ", qna_member_no=" + qna_member_no + ", qna_title=" + qna_title
